...
- **No theatrical or performative framing (hard rule Prasad repeats, and keeps having to repeat).** Cut writerly flourishes and self-aware narration. Say the thing; do not perform saying it. Banned patterns, with real examples that slipped through: metaphor closers ("building that felt like the mountain, it was the foothill"); "before reaching for the keyboard"; "grateful in a way that does not fit in a sentence"; "that is the whole edge"; "I paid to learn it, and I would pay again"; "the system is the moat, the model is a tenant"; "X is its own kind of Y"; "a way to lose money quickly with great confidence". Performative transitions and instructions: "here is where it stops being abstract", "worth pausing on", "read this carefully, because", "notice the", "let me be honest up front". Grand section titles: "the property that makes it all worth it". End sections and sentences plainly, on a concrete fact. KEEP the earned real-world analogies (chess move list, double-entry ledger, entropy); it is the framing wrapped around them that gets cut, not the analogy itself.
- **No extreme framing.** "create duplicate or inconsistent data", not "a source of corruption".
- **No vague generalizations standing in for a fact.** Never hedge to "most", "many", "often", "studies show", or "industry average" to dodge finding the real number. If a claim has a real figure, state it and cite the source; if it does not, cut the claim. Vague quantifiers used as filler are an AI tell and are banned. (This is a hard rule Prasad called out explicitly.)
- **No negativity or dismissiveness for effect.** Do not belittle work, demos, or people to sound sharp ("demos are easy", "tells you little", "garbage"). Default to a natural, optimistic, honest register: acknowledge what is real, then say what the harder part is. "Of course you can show a good demo; taking it to production and delivering real value is the work." Write like Paul Graham: plain words, conversational, grounded, generous.
