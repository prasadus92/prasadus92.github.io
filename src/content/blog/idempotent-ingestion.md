...
- Delivery count. Junction delivers at least once. The same event arrives twice when an ack is slow.
...
The thing I would tell anyone building this: the raw-event table is the best decision in the design, and it took doing it to believe it. It does three jobs at once.
