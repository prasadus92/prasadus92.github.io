...
<p class="reveal">
    I've been running a similar workflow since mid-2025 while building Luminik across product, GTM, and content systems. CLAUDE.md files with detailed coding conventions. A specs repo that agents reference every session. Multiple agents running in parallel across repos overnight. gstack formalizes part of what I arrived at through trial and error.
</p>
