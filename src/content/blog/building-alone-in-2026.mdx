...
<CompareTable
  ...
  rows={[
    ...
    { dimension: "Coordination", left: "Standups, code reviews, whiteboards", right: "Specs repo, instruction files, PRs I inspect" },
...
<h2 class="reveal">Parallel agents and PRs to inspect</h2>
